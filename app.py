...
import razorpay
razorpay_key_id="rzp_test_WIoUIikq8XPiDa"
razorpay_key_secret="6anAfofr8IsBuTCjhdRvuFTx"
...
def registerdata():
    if request.method == "POST":
        ...
        if password==cpassword:
            ...
            smtp_port=587
            mailusername="ankithabandi8213@gmail.com"
            mailpassword="eonp wrwa mtsf xgbx"
            from_email="ankithabandi8213@gmail.com"
            to_email=email
    ...
    if request.method == "POST":
        ...
        if otp==verifyotp:
            try:
                ...
                return "Error occured while storing data in database or username already exists"
            else:
                return render_template("login.html")
        else:
            return "wrong otp"
